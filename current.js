    ...
    function vrem() {
        ...
        function currentrasp(){
         ...
         //       document.getElementById('zoom').innerHTML = ('<a class="zoom" href="https://us04web.zoom.us/j/71494614149?pwd=Rk1ZQWF5L2lyR1JJbVBvOUZPc1BuZz09">Ссылка на Zoom</a>');
         //   }
        // Понедельник
        if (Day == 1) {
        ...
        if (Day == 4) {
            ...
            if (time >= 0800 && time < 0850) {
                document.getElementById('current-time').innerHTML = ('8:00-8:50');
                document.getElementById('current-name').innerHTML = ('<span class="desktop-name">Цифровая схемотехника</span><span class="mobile-name">ЦСТ</span><span class="type lab">Лабораторная работа</span>');
                document.getElementById('current-prep').innerHTML = ('Наумов В.В.');
                document.getElementById('current-links').innerHTML = ('<a href="" onClick="window.open(&quot;https:\/\/cdo.ineu.kz\/mod\/chat\/gui_ajax\/index.php?id=5173&quot;, &quot;Chat&quot;, &quot;Width=800, Height=600&quot;)">Чат</a><a href="https://cdo.ineu.kz/course/view.php?id=5142">Страница курса</a>');
            }
            if (time >= 0900 && time < 0950) {
                document.getElementById('current-time').innerHTML = ('9:00-9:50');
                document.getElementById('current-name').innerHTML = ('<span class="desktop-name">Цифровая схемотехника</span><span class="mobile-name">ЦСТ</span><span class="type lab">Лабораторная работа</span>');
        ...
        if (Day == 5) {
            ...
            if (time >= 1420 && time < 1510) {
                document.getElementById('current-time').innerHTML = ('14:20-15:10');
                document.getElementById('current-name').innerHTML = ('<span class="desktop-name">Цифровая схемотехника</span><span class="mobile-name">ЦСТ</span><span class="type lection">Лекция</span>');
                document.getElementById('current-prep').innerHTML = ('Наумов В.В.');
                document.getElementById('current-links').innerHTML = ('<a href="" onClick="window.open(&quot;https:\/\/cdo.ineu.kz\/mod\/chat\/gui_ajax\/index.php?id=5173&quot;, &quot;Chat&quot;, &quot;Width=800, Height=600&quot;)">Чат</a><a href="https://cdo.ineu.kz/course/view.php?id=5142">Страница курса</a>');
            }
            if (time >= 1520 && time < 1610) {
                document.getElementById('current-time').innerHTML = ('15:20-16:10');
                document.getElementById('current-name').innerHTML = ('<span class="desktop-name">Цифровая схемотехника</span><span class="mobile-name">ЦСТ</span><span class="type srsp">СРСП</span>');
                document.getElementById('current-prep').innerHTML = ('Наумов В.В.');
                document.getElementById('current-links').innerHTML = ('<a href="" onClick="window.open(&quot;https:\/\/cdo.ineu.kz\/mod\/chat\/gui_ajax\/index.php?id=5173&quot;, &quot;Chat&quot;, &quot;Width=800, Height=600&quot;)">Чат</a><a href="https://cdo.ineu.kz/course/view.php?id=5142">Страница курса</a>');
            }
            // Перемены
