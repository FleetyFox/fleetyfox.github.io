    ...
    function vrem() {
        ...
        if (Day == 5) {
            ...
            if (time >= 0800 && time < 0850) {
                document.getElementById('current-time').innerHTML = ('8:00-8:50');
                document.getElementById('current-name').innerHTML = ('<span class="desktop-name">IT-инфраструктура</span><span class="mobile-name">ITИнф</span><span class="type lab">Лабораторная работа</span>');
                document.getElementById('current-prep').innerHTML = ('Тюлюгенова Л.Б.');
                document.getElementById('current-links').innerHTML = ('<a href="" onClick="window.open(&quot;https:\/\/cdo.ineu.kz\/mod\/chat\/gui_ajax\/index.php?id=5549&quot;, &quot;Chat&quot;, &quot;Width=800, Height=600&quot;)">Чат</a><a href="https://cdo.ineu.kz/course/view.php?id=5527">Страница курса</a>');
            }
            if (time >= 0900 && time < 0950) {
                document.getElementById('current-time').innerHTML = ('9:00-9:50');
